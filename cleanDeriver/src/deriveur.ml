...
| "tan" -> Printf.printf "\\tan"
| "exp" -> Printf.printf "\\exp"
| "ln" ->  Printf.printf "\\ln"
| str -> Printf.printf "%s" str;;
...
| Leaf po -> Printf.printf "%s" (float_to_good_str po); ()
| X -> Printf.printf "X";;
...
| Node (op,exp1,exp2) -> begin match op with
          ...
          | Mult -> Printf.printf "(" ;print_exp_latex exp1 ; Printf.printf ")\\times(" ; print_exp_latex exp2; Printf.printf ")" ; ()
          | Quotient -> Printf.printf "\\frac{" ;print_exp_latex exp1 ; Printf.printf "}{" ; print_exp_latex exp2; Printf.printf "}" ; ()
          end
| Fonction (f,exp1) -> printf_f_latex f;print_string "(";print_exp_latex exp1 ;print_string ")"; ()
| Leaf po -> Printf.printf "%s" (float_to_good_str po); ()
| X -> Printf.printf "x";;
...
(* Petite fonction de nettoyage d'une structure, efficacité limitée *)
