...
| Node (c1,l,c2) -> if v<l then insert v c1 else insert v c2
;;
...
let hash=
  ...
  | str::t -> match String.length str with
              ...
              | n -> arr.((c_code str 0)*28*28*28*28+(c_code str 2)*28*28*28+(c_code str 4)*28*28+(c_code str 6)*28+(c_code str 8)+remain n) <- insert str arr.((c_code str 0)*28*28*28*28+(c_code str 2)*28*28*28+(c_code str 4)*28*28+(c_code str 6)*28+(c_code str 8)+remain n);
